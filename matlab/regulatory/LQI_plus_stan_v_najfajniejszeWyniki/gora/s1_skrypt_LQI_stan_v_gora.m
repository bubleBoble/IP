...
%=======================================================================%
E = [1 0 0 0];
Aa = [A, B, zeros(4,1); zeros(1, 6); E,0,0];
Ba = [zeros(4, 1); 1; 0];

%=======================================================================%
%   LQR 1
%=======================================================================%
Q = diag( [3e3, 1, 0, 0, 0, 1] );
R = 0.02;
Fa=lqr(Aa, Ba, Q, R)
%%
%=======================================================================%
...
%%
simout = sim('s1_model_LQI_stan_v_gora.slx');
x       = simout.state_out;
t       = simout.tout;
u       = simout.u;
d       = simout.d;
